...
当前4个TOP质量事项：
1. **TOP-001** 客户场景仿真&镜像测试推进
2. **TOP-002** 轻量级用例前移与门禁集成
3. **TOP-003** 转测风险评级与标准评估
4. **TOP-004** 需求交付质量标准
...
2. **日期格式**
   - 支持自动转换：5/13 → 2026-05-13
   - 支持自动转换：5-13 → 2026-05-13
   - 支持自动修正：2024-XX-XX → 2026-XX-XX
...
- 独立模块，从【事故统计】标签页进入
- 关联事故、改进措施、负责人、预期闭环时间
- 支持进度跟踪（未开始/进行中/已完成/已闭环）
